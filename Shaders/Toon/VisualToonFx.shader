...
Shader "KortyBoi/Toon/VFX"
{
    Properties
    {
        ...
        [Gradient]_GradientMap ("Gradient map", 2D) = "white" { }
        [HDR]_Color ("Color", Color) = (1, 1, 1, 1)
        _PanningSpeed ("Panning speed (XY main texture - ZW displacement texture)", Vector) = (0, 0, 0, 0)
        
        [HideInInspector] m_secondaryTextures ("Secondary texture", Float) = 0
        [Space(20)]
        ...
        //Clipping
        [HideInInspector] m_clipping ("Clipping", Float) = 0
        [Space(20)]
        ...
        //Softness
        [HideInInspector] m_softness ("Softness", Float) = 0
        [Space(20)]
        [Toggle(SOFT_BLEND)]
        ...
        //Vertex offset
        [HideInInspector] m_vertexOffset ("Vertex Offset", Float) = 0
        [Space(20)]
        ...
        //Displacement
        [HideInInspector] m_displacement ("Displacement", Float) = 0
        [Space(20)]
        _DisplacementAmount ("Displacement", float) = 0
        _DisplacementGuide ("DisplacementGuide", 2D) = "white" { }
        
        //Culling
        [HideInInspector] m_culling ("Culling", Float) = 0
        [Space(20)]
        [Enum(UnityEngine.Rendering.CullMode)] _Culling ("Cull Mode", Int) = 2
        
        //Banding
        [HideInInspector] m_banding ("Banding", Float) = 0
        [Space(20)]
        [Toggle(BANDING)]
        ...
        //Polar coordinates
        [HideInInspector] m_polarCoordinates ("Polar coordinates", Float) = 0
        [Space(20)]
        [Toggle(POLAR)]
        _PolarCoords ("Polar coordinates", float) = 0
        
        //Circle mask
        [HideInInspector] m_circleMask ("Circle Mask", Float) = 0
        [Space(20)]
        [Toggle(CIRCLE_MASK)]
        ...
        //Rect mask
        [HideInInspector] m_rectMask ("Rect mask", Float) = 0
        [Space(20)]
        [Toggle(RECT_MASK)]
